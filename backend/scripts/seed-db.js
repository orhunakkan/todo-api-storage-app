  ...
  try {
    ...
    const todos = [
      ...
      },
      {
        ...
        description: 'Weekly team standup meeting at 10 AM',
        priority: 'medium',
        user_id: userIds[1],
        category_id: categoryIds[0],
      },
      ...
      },
      {
        ...
        description: 'Schedule regular dental cleaning',
        priority: 'medium',
        user_id: userIds[1],
        category_id: categoryIds[1],
        completed: true,
      },
      {
        ...
        description: 'Research and plan weekend getaway',
        priority: 'low',
        user_id: userIds[3],
        category_id: categoryIds[1],
      },
      ...
      {
        title: 'Buy groceries',
        description: 'Weekly grocery shopping - need milk, bread, eggs',
        priority: 'medium',
        user_id: userIds[2],
        category_id: categoryIds[2],
      },
      {
        title: 'Get birthday gift',
        description: 'Buy birthday present for Sarah',
        priority: 'high',
        user_id: userIds[3],
        category_id: categoryIds[2],
      },
      {
        title: 'Replace broken phone charger',
        description: 'Buy new USB-C charger for phone',
        priority: 'medium',
        user_id: userIds[0],
        category_id: categoryIds[2],
        completed: true,
      ...
      },
      {
        ...
        description: 'Attend beginners yoga class at local studio',
        priority: 'low',
        user_id: userIds[3],
        category_id: categoryIds[3],
      },
      ...
      // Learning todos
      {
        ...
        description: 'Finish remaining 5 modules of the JavaScript course',
        priority: 'medium',
        user_id: userIds[1],
      ...
      },
      {
        ...
        description: 'Read next chapter of "Clean Code"',
        priority: 'low',
        user_id: userIds[2],
        category_id: categoryIds[4],
      },
      ...
      // Home todos
      {
        ...
        description: 'Repair the dripping kitchen faucet',
        priority: 'high',
        user_id: userIds[0],
      ...
      {
        title: 'Plant flowers',
        description: 'Plant spring flowers in the front garden',
        priority: 'medium',
        user_id: userIds[2],
        category_id: categoryIds[5],
      },
      ...
      {
        title: 'Check email',
        description: 'Go through and organize email inbox',
        priority: 'low',
        user_id: userIds[0],
        category_id: null,
        completed: true,
