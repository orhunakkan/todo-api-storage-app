      ...
      <div className='min-h-screen flex items-center justify-center'>
        <div className='text-center'>
          ...
          <div className='space-x-4'>
            <button onClick={() => navigate('/todos')} className='btn btn-outline'>
              Back to Todos
            </button>
            <button onClick={fetchTodo} className='btn btn-primary'>
              Try Again
            </button>
          </div>
        </div>
      ...
      <div className='card p-8'>
        ...
        {todo.description && (
          <div className='mb-6'>
            ...
            <p className='text-gray-600 dark:text-gray-400 leading-relaxed'>{todo.description}</p>
          </div>
        )}
        ...
        <div className='mt-8 pt-6 border-t border-gray-200 dark:border-gray-700'>
          <div className='flex justify-between items-center'>
            ...
            <div className='text-sm text-gray-500 dark:text-gray-400'>Todo ID: {todo.id}</div>
          </div>
        </div>
      </div>
