    ...
    <div className='min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8' data-testid="not-found-page">
      <div className='max-w-md w-full text-center'>
        ...
        <div className='mb-8' data-testid="not-found-graphic">
          <div className='text-9xl font-bold text-gray-200 dark:text-gray-800 select-none' data-testid="not-found-404-text">404</div>
        ...
        <div className='mb-8' data-testid="not-found-content">
          <h1 className='text-2xl font-bold text-gray-900 dark:text-white mb-4' data-testid="not-found-title">Page Not Found</h1>
