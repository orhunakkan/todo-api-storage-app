  ...
  return (
    <div className='fixed inset-0 z-50 overflow-y-auto' data-testid='confirm-dialog'>
      <div className='flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0'>
        ...
        {/* Modal */}
        <div
          className='relative inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-gray-900 shadow-xl rounded-xl'
        ...
        >
          ...
          <div className='flex items-center justify-between mb-4'>
            <div className='flex items-center'>
              ...
              <h3 className='ml-3 text-lg font-medium text-gray-900 dark:text-white' data-testid='confirm-dialog-title'>
                {title}
              </h3>
            </div>
            <button
          ...
          {/* Content */}
          <div className='mb-6'>
            <p className='text-sm text-gray-600 dark:text-gray-400' data-testid='confirm-dialog-message'>
              {message}
            </p>
          </div>
