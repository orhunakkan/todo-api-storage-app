        ...
        <div className='flex justify-between h-16'>
          ...
          <div className='flex'>
            <div className='flex-shrink-0 flex items-center'>
              <Link to='/dashboard' className='text-xl font-bold text-primary-600 dark:text-primary-400' data-testid='navbar-logo'>
                TodoApp
              </Link>
            </div>
            ...
            {user ? (
              <div className='flex items-center space-x-4' data-testid='navbar-user-section'>
                <div className='hidden sm:flex sm:items-center sm:space-x-2' data-testid='navbar-user-info'>
                  ...
                  <span className='text-sm text-gray-700 dark:text-gray-300'>{user.first_name || user.username}</span>
                </div>
                <button
                  onClick={logout}
